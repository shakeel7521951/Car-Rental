        ...
        <div className="w-full md:w-1/2 flex flex-col p-8 ">
          ...
          <div className="flex items-center justify-between my-4">
            <div className="flex items-center cursor-pointer">
              ...
              <label htmlFor="remember" className="text-gray-600 cursor-pointer text-sm">
                Remember me
              </label>
            </div>
            <span className="text-blue-500 font-medium cursor-pointer text-sm">
              Forgot password?
            </span>
          </div>

          <button
            className="w-full bg-blue-600 cursor-pointer text-white p-3 rounded-lg mt-4 font-semibold hover:bg-blue-700 transition duration-300 shadow-md"
          ...
          <button className="flex items-center justify-center w-full border cursor-pointer border-gray-300 p-3 rounded-lg font-medium hover:bg-gray-100 transition duration-300">
